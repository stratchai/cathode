...
// ── Cell param shapes (ag-Grid-compatible naming) ─────────────────────────────
...
// ── Grid API (ag-Grid-compatible surface) ─────────────────────────────────────
...
export interface GridApi {
  ...
  applyColumnState(params: { state: ColState[], applyOrder?: boolean }): void
  ...
  refreshCells(params?: { columns?: string[], force?: boolean }): void
...
// ── Internal resolved column (after merging defaultColDef) ────────────────────
